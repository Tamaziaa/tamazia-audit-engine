...
test('ENGINE_VERSION is the frozen WS-Signals engine version (Rule 15: it rides the idempotency key)', () => {
  assert.strictEqual(version.ENGINE_VERSION, 'engine-v2.1.6-ws-signals');
