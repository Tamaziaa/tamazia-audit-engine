<!-- qa-approval pack_sha256=d28ba76158073bfe7847aa39d49dea7d9c0cab5a20c7636fc3b46b16e3fce78d verdict=approved reviewed=2026-07-27 -->
...
Changes verified against sources on 2026-07-27:
- **`US_MEDBOARD_ADV_CA` WIDENED to its statutory truth** - Cal. B&P s.651 verified: it binds "any person licensed under this division" (Division 2, Healing Arts) and expressly covers Internet communications - i.e. physicians AND dentists, nurses, pharmacists, optometrists. The record's name/applies_when/regulator previously framed it as medical-board-only, which made a CA dental or pharmacy practice look like it was inheriting an ill-fitting medical rule; the citation (s.651 + s.2271) was already correct and is unchanged. This closes the "non-medical provider boards" gap for CA with zero new law.
- **`US_MEDBOARD_ADV_NY` WIDENED the same way** - 8 NYCRR 29.1(b)(12) verified at op.nysed.gov: a Rules-of-the-Board-of-Regents provision covering ALL Regents-regulated professions (dentistry, nursing, pharmacy...); physicians via Educ. Law 6530(27) as already cited. citation.url now points at the Part 29 rules page (covers every profession) with the old physician-page URL retained in provenance.
- **NEW RECORD `US_SEC1557_NOTICES`** - 45 CFR 92.10 (notice of nondiscrimination: annual + conspicuous website posting, OCR complaint route, 1557 Coordinator where 15+ employees) and 92.11 (notice of availability of free language assistance, English + top-15 state LEP languages) verified via eCFR section pages. Distinct from `US_HHS_504_WEB` (accessibility) - this is the civil-rights NOTICE duty pair, both presence-detectable on the website. Penalty is regulator-action (OCR corrective action/funding termination), no invented figures; applies_when scopes to federal financial assistance (Medicare/Medicaid participation), excluded_when carves out providers with no federal funding.
- **NEW RECORD `US_STATE_BOARD_BASELINE`** - the honest 45-state provider-board record, parallel to us-legal's bar baseline: CA/NY/TX/FL/IL modelled individually; everywhere else the licensee's own board's advertising rules bind and must be verified (behavioural). excluded_when carves out the five modelled states.
Known remaining gaps, stated rather than papered over: TX/FL records stay medical-framed (their cited chapters were not re-verified for cross-profession scope this session); `US_MEDBOARD_ADV_IL` remains status needs_verification and excluded from the artifact; BetterHelp and OCR tracking-tech cases were not added because they were not re-verified at source this session (GoodRx already carries the verified HBNR action). - Linter-driven correction (same wave): `US_STATE_BOARD_BASELINE` citation re-anchored to the official HHS licensure page (telehealth.hhs.gov, .gov host) and register_url set null (matching the US_TELEHEALTH_LICENSURE precedent); fsmb.org (a nonprofit federation, not a statutory host) removed.
